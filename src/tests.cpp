...
namespace transport {
    ...
    using namespace std::filesystem;
        ...
        void TestNull() {
            ...
            void TestStrings() {
                Node str_node{R"(Hello, "everybody")"};
        ...
        void TestTxtFiles(const path& test_path, const path& standard_path, std::ostream& out_logs){
        ...
        void TestJsonFiles(const path& test_path, const path& standard_path, std::ostream& out_logs){
            LOG_DURATION(standard_path.filename().string());
            TransportCatalogue catalogue;
            path result_path = test_path.parent_path().
                    append(test_path.stem().string()).string().
        ...
        void TestSvgFiles(const path& test_path, const path& standard_path, std::ostream& out_logs){
            LOG_DURATION(standard_path.filename().string());
            TransportCatalogue catalogue;
            path result_path = test_path.parent_path().
                    append(test_path.stem().string()).string().
