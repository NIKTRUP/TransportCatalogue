#ifndef TRANSPORTCATALOGUE_ROUTER_H
#define TRANSPORTCATALOGUE_ROUTER_H
...
/// - Конструктор маршрутизатора имеет сложность O(V^3 + E),
/// где V — количество вершин графа, E — количество рёбер.
...
namespace graph {
    ...
    public:
        ...
        Router(const Graph &graph, const RoutesInternalData &internal_data);
    ...
    private:
        ...
        // Инициализирует данные для маршрутизатора
...
#endif //TRANSPORTCATALOGUE_ROUTER_H
